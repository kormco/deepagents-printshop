...
def _fix_common_llm_typos(tex_content: str) -> str:
...
def _close_unclosed_environments(tex_content: str) -> str:
...
def _llm_fix_latex(tex_content: str, error_log: str, attempt: int) -> Optional[str]:
    ...
    try:
        ...
        if original_preamble:
            ...
            fixed = _fix_common_llm_typos(fixed)
            fixed = _close_unclosed_environments(fixed)
